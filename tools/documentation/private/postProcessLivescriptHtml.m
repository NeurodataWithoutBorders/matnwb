function postProcessLivescriptHtml(htmlFile)
    ...
    updatedHtmlContent = strrep(updatedHtmlContent, ...
        'https://neurodatawithoutborders.github.io/matnwb/doc/+types/+core/', ...
        'https://matnwb.readthedocs.io/en/latest/pages/neurodata_types/core/' );
       
    updatedHtmlContent = strrep(updatedHtmlContent, ...
        'https://neurodatawithoutborders.github.io/matnwb/doc/+types/+hdmf_common/', ...
        'https://matnwb.readthedocs.io/en/latest/pages/neurodata_types/hdmf_common/' );
