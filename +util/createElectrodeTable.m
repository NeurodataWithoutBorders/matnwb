...
if exist(fullfile('+types', '+core', 'ElectrodesTable.m'), 'file')
    % Electrodestable was introduced in v2.9.0
    tableConstructor = @types.core.ElectrodesTable;
else
    tableConstructor = @types.hdmf_common.DynamicTable;
end
