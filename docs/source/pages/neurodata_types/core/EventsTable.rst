...
See also:
  :nwb-core-type-schema:`Format Specification<eventstable>` 
  or :nwb-core-type-schema:`Source Specification<sec-eventstable-src>` for EventsTable.

.. mat:module:: types.core
.. autoclass:: types.core.EventsTable
    :members:
    :show-inheritance:
