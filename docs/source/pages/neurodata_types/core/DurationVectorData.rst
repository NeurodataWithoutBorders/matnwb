...
See also:
  :nwb-core-type-schema:`Format Specification<durationvectordata>` 
  or :nwb-core-type-schema:`Source Specification<sec-durationvectordata-src>` for DurationVectorData.

.. mat:module:: types.core
.. autoclass:: types.core.DurationVectorData
    :members:
    :show-inheritance:
