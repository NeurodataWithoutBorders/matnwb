...
See also:
  :nwb-core-type-schema:`Format Specification<externalimage>` 
  or :nwb-core-type-schema:`Source Specification<sec-externalimage-src>` for ExternalImage.

.. mat:module:: types.core
.. autoclass:: types.core.ExternalImage
    :members:
    :show-inheritance:
