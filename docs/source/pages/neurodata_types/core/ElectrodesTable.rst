...
See also:
  :nwb-core-type-schema:`Format Specification<electrodestable>` 
  or :nwb-core-type-schema:`Source Specification<sec-electrodestable-src>` for ElectrodesTable.

.. mat:module:: types.core
.. autoclass:: types.core.ElectrodesTable
    :members:
    :show-inheritance:
