...
See also:
  :nwb-hdmf_common-type-schema:`Format Specification<herd>` 
  or :nwb-hdmf_common-type-schema:`Source Specification<sec-herd-src>` for HERD.

.. mat:module:: types.hdmf_common
.. autoclass:: types.hdmf_common.HERD
    :members:
    :show-inheritance:
