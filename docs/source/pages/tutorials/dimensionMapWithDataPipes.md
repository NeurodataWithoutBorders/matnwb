(dimensionMapWithDataPipes-tutorial)=
...
This tutorial is easier to follow if you have already looked at the [**dimensionMapNoDataPipes**](dimensionMapNoDataPipes) tutorial or if you compare these side by side.
...
![image_0.png](../../_static/tutorials/media/dimensionMapWithDataPipes/image_0.png){.tutorial-media width=952px}


![image_1.png](../../_static/tutorials/media/dimensionMapWithDataPipes/image_1.png){.tutorial-media width=952px}


![image_2.png](../../_static/tutorials/media/dimensionMapWithDataPipes/image_2.png){.tutorial-media width=952px}


![image_3.png](../../_static/tutorials/media/dimensionMapWithDataPipes/image_3.png){.tutorial-media width=952px}
