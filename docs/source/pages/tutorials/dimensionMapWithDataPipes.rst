...
This tutorial is easier to follow if you have already looked at the `dimensionMapNoDataPipes <dimensionMapNoDataPipes>`_ tutorial or if you compare these side by side.
...
.. image:: ../../_static/tutorials/media/dimensionMapWithDataPipes/image_0.png
   :class: tutorial-media
   :width: 952px
   :alt: image_0.png

.. image:: ../../_static/tutorials/media/dimensionMapWithDataPipes/image_1.png
   :class: tutorial-media
   :width: 952px
   :alt: image_1.png

.. image:: ../../_static/tutorials/media/dimensionMapWithDataPipes/image_2.png
   :class: tutorial-media
   :width: 952px
   :alt: image_2.png

.. image:: ../../_static/tutorials/media/dimensionMapWithDataPipes/image_3.png
   :class: tutorial-media
   :width: 952px
   :alt: image_3.png
