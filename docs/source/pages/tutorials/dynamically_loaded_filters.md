(dynamically_loaded_filters-tutorial)=
...
![image_0.png](../../_static/tutorials/media/dynamically_loaded_filters/image_0.png){.tutorial-media width=1084px}
...
The `DynamicFilter` property accepts an enumerated type `Filter` where the enumeration members represent a hard\-coded subset of the [registered filter plugins](https://github.com/HDFGroup/hdf5_plugins/blob/master/docs/RegisteredFilterPlugins.md) in HDF5.
...
![image_1.png](../../_static/tutorials/media/dynamically_loaded_filters/image_1.png){.tutorial-media width=951px}
