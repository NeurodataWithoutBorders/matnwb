...
-  Find and select a dandiset you want on the [DANDI Archive](https://dandiarchive.org/dandiset), then click ![image_0.png](../../_static/tutorials/media/remote_read/image_0.png){.tutorial-media width=121px} 
-  Navigate to the NWB file of interest and click ![image_1.png](../../_static/tutorials/media/remote_read/image_1.png){.tutorial-media width=30px} 
-  Find the second entry of "contentURL"![image_2.png](../../_static/tutorials/media/remote_read/image_2.png){.tutorial-media width=688px} 
