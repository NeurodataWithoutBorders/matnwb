...
This tutorial will focus on the basics of working with a [**`NWBFile`**](https://matnwb.readthedocs.io/en/latest/pages/neurodata_types/core/NWBFile.html) for storing non\-standardizable data. For example, you may want to store results from one\-off analyses of some temporary utility. NWB provides in\-file  **scratch space** as a dedicated location where miscellaneous non\-standard data may be written.
  ...
  TimeSeries with properties:
    ...
    timestamps_interval: 1
        timestamps_unit: 'seconds'
                   data: [-0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062 -0.0062]
              data_unit: 'm'
...
![image_0.png](../../_static/tutorials/media/scratch/image_0.png){.tutorial-media width=1029px}
