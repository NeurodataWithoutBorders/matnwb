classdef DynamicTableTest < tests.system.RoundTripTest & tests.system.AmendTest
    methods
        ...
        function addExpandableContainer(~, file, start_array, stop_array, random_array, id_array)
            ...
            start_time_exp = types.hdmf_common.VectorData(...
                ...
                'data', types.untyped.DataPipe('data', start_array', ...
                        'maxSize', [Inf, 1], ...
                        'axis', 1 ...
                        )...
            );
            stop_time_exp = types.hdmf_common.VectorData(...
                ...
                'data', types.untyped.DataPipe('data', stop_array', ...
                        'maxSize', [Inf, 1], ...
                        'axis', 1 ...
                        )...
            );
            random_exp = types.hdmf_common.VectorData(...
                ...
                'data', types.untyped.DataPipe('data', random_array, ...
                        'maxSize', [Inf, 1], ...
                        'axis', 1 ...
                        )...
            );
            ids_exp = types.hdmf_common.ElementIdentifiers(...
                'data', types.untyped.DataPipe('data', id_array', ... 
                        'maxSize', [Inf, 1], ...
                        'axis', 1 ...
                        )...
            );
    ...
    methods (Test)
        ...
        function ExpandableTableTest(testCase)
            ...
            %create reference static table
            refTable = types.hdmf_common.DynamicTable(...
            ...
            expectedData = refTable.getRow(42,...
                'columns', {'randomvalues'});
            actualData = readFile.intervals_trials.getRow(42,...
                'columns', {'randomvalues'});
            testCase.verifyEqual(expectedData, actualData);
            %test getRow for appended portion of table
            expectedData = refTable.getRow(155,...
                'columns', {'randomvalues'});
