classdef DynamicTableTest < tests.system.RoundTripTest & tests.system.AmendTest
    methods
        ...
        function appendContainer(testCase, file)
            ...
            container.data = rand(2, 800); % new random values.
            file.intervals_trials.vectordata.get('stringdata').data = repmat({'FALSE'}, 1, 100);
            %test adding new column with
            ...
            testCase.verifyError(@() file.intervals_trials.addColumn(sub_table), ...
                "NWB:DynamicTable");
    ...
    methods (Test)
        ...
        function toTableTest(testCase)
            ...
            DTRCol = types.hdmf_common.DynamicTableRegion( ...
                ...
                'data', randi([0 99],100,1), ...  # 0-indexed
