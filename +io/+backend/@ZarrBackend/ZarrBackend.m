classdef ZarrBackend < io.backend.FileBackend
    ...
    methods
        ...
        function info = getFileInfo(obj)
            info = io.internal.zarr.zarrinfo(obj.Filename);
        end
               
        function version = getSchemaVersion(obj)
            version = io.internal.zarr.getSchemaVersion(obj.Filename);
        end
               
        function specLocation = getEmbeddedSpecLocation(obj)
            specLocation = io.internal.zarr.getEmbeddedSpecLocation(obj.Filename);
        end
