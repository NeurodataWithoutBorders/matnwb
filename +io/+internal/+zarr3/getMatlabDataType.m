...
%
% Resolves the MATLAB class used to represent values of the given Zarr v3
% `data_type` (e.g. "float64", "int64", "bool", "string"), reusing the dtype
% table from the zarr-matlab package.
