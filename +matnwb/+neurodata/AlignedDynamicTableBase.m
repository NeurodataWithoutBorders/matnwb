        ...
        % validation/export.
            ...
            if ~isempty(unmaterializedCategoryNames) && parentHasHeight && parentHeight > 0
                ...
                obj.handleCategoryNamesMismatch( ...
                    ...
                    'The table already has %d rows, and all category tables ', ...
                    'must have the same height as the parent table. ', ...
                    'Add the missing table(s) with the addCategory method, ', ...
                    'or list categories only before the table has rows.'], ...
                    classShortName, strjoin(unmaterializedCategoryNames, ', '), parentHeight);
            end
