classdef BehavioralEvents < types.NWBContainer
  ...
  methods %constructor
    function obj = BehavioralEvents(varargin)
      ...
      obj.help = {'Position data, whether along the x, xy or xyz axis'};
      ...
      if ~isempty(gn)
        for i=1:length(gn)
          gnm = gn{i};
          if isfield(obj, gnm)
            error('Naming conflict found in BehavioralEvents object property name: ''%s''', gnm);
          else
            addprop(obj, gnm);
