classdef DynamicTable < types.hdmf_common.Container & types.untyped.GroupClass & matnwb.mixin.HasUnnamedGroups & matnwb.neurodata.DynamicTableBase
...
properties (Constant, Access = private)
    SchemaRelativePaths = ["colnames", "description"];
end
