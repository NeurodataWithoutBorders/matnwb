...
% REQUIRED PROPERTIES
properties
    rois; % REQUIRED (DynamicTableRegion) DynamicTableRegion referencing into a PlaneSegmentation table containing information on the ROIs stored in this TimeSeries.
end
...
methods
    function obj = RoiResponseSeries(varargin)
        ...
        %
        %  - rois (DynamicTableRegion) - DynamicTableRegion referencing into a PlaneSegmentation table containing information on the ROIs stored in this TimeSeries.
        %
