...
methods
    ...
    function val = validate_focal_depth_image_bits_per_pixel(obj, val)
        ...
        types.util.validateShape('focal_depth_image_bits_per_pixel', {[1]}, val)
    end
    function val = validate_focal_depth_image_dimension(obj, val)
        val = types.util.checkDtype('focal_depth_image_dimension', 'int32', val);
        types.util.validateShape('focal_depth_image_dimension', {[2]}, val)
    end
    function val = validate_focal_depth_image_field_of_view(obj, val)
        ...
        types.util.validateShape('focal_depth_image_field_of_view', {[2]}, val)
    end
    ...
    function val = validate_vasculature_image_bits_per_pixel(obj, val)
        ...
        types.util.validateShape('vasculature_image_bits_per_pixel', {[1]}, val)
    end
    function val = validate_vasculature_image_dimension(obj, val)
        val = types.util.checkDtype('vasculature_image_dimension', 'int32', val);
        types.util.validateShape('vasculature_image_dimension', {[2]}, val)
    end
    function val = validate_vasculature_image_field_of_view(obj, val)
        ...
        types.util.validateShape('vasculature_image_field_of_view', {[2]}, val)
    end
    function val = validate_vasculature_image_format(obj, val)
        val = types.util.checkDtype('vasculature_image_format', 'char', val);
        types.util.validateShape('vasculature_image_format', {[1]}, val)
    end
    %% EXPORT
    function refs = export(obj, writer, fullpath, refs)
        ...
        if startsWith(class(obj.axis_1_phase_map), 'types.untyped.')
            refs = obj.axis_1_phase_map.export(writer, [fullpath '/axis_1_phase_map'], refs);
        elseif ~isempty(obj.axis_1_phase_map)
            writer.writeValue([fullpath '/axis_1_phase_map'], obj.axis_1_phase_map, 'forceArray', 'forceMatrix');
        end
        if ~isempty(obj.axis_1_phase_map) && ~isa(obj.axis_1_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_phase_map/dimension'], obj.axis_1_phase_map_dimension, 'forceArray');
        ...
        if ~isempty(obj.axis_1_phase_map) && ~isa(obj.axis_1_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_phase_map/field_of_view'], obj.axis_1_phase_map_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.axis_1_phase_map) && ~isa(obj.axis_1_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_phase_map/unit'], obj.axis_1_phase_map_unit);
        ...
        if ~isempty(obj.axis_1_power_map)
            if startsWith(class(obj.axis_1_power_map), 'types.untyped.')
                refs = obj.axis_1_power_map.export(writer, [fullpath '/axis_1_power_map'], refs);
            elseif ~isempty(obj.axis_1_power_map)
                writer.writeValue([fullpath '/axis_1_power_map'], obj.axis_1_power_map, 'forceArray', 'forceMatrix');
            end
        end
        if ~isempty(obj.axis_1_power_map) && ~isa(obj.axis_1_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_power_map/dimension'], obj.axis_1_power_map_dimension, 'forceArray');
        ...
        if ~isempty(obj.axis_1_power_map) && ~isa(obj.axis_1_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_power_map/field_of_view'], obj.axis_1_power_map_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.axis_1_power_map) && ~isa(obj.axis_1_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_1_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_1_power_map/unit'], obj.axis_1_power_map_unit);
        ...
        if startsWith(class(obj.axis_2_phase_map), 'types.untyped.')
            refs = obj.axis_2_phase_map.export(writer, [fullpath '/axis_2_phase_map'], refs);
        elseif ~isempty(obj.axis_2_phase_map)
            writer.writeValue([fullpath '/axis_2_phase_map'], obj.axis_2_phase_map, 'forceArray', 'forceMatrix');
        end
        if ~isempty(obj.axis_2_phase_map) && ~isa(obj.axis_2_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_phase_map/dimension'], obj.axis_2_phase_map_dimension, 'forceArray');
        ...
        if ~isempty(obj.axis_2_phase_map) && ~isa(obj.axis_2_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_phase_map/field_of_view'], obj.axis_2_phase_map_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.axis_2_phase_map) && ~isa(obj.axis_2_phase_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_phase_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_phase_map/unit'], obj.axis_2_phase_map_unit);
        ...
        if ~isempty(obj.axis_2_power_map)
            if startsWith(class(obj.axis_2_power_map), 'types.untyped.')
                refs = obj.axis_2_power_map.export(writer, [fullpath '/axis_2_power_map'], refs);
            elseif ~isempty(obj.axis_2_power_map)
                writer.writeValue([fullpath '/axis_2_power_map'], obj.axis_2_power_map, 'forceArray', 'forceMatrix');
            end
        end
        if ~isempty(obj.axis_2_power_map) && ~isa(obj.axis_2_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_power_map/dimension'], obj.axis_2_power_map_dimension, 'forceArray');
        ...
        if ~isempty(obj.axis_2_power_map) && ~isa(obj.axis_2_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_power_map/field_of_view'], obj.axis_2_power_map_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.axis_2_power_map) && ~isa(obj.axis_2_power_map, 'types.untyped.SoftLink') && ~isa(obj.axis_2_power_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/axis_2_power_map/unit'], obj.axis_2_power_map_unit);
        ...
        if startsWith(class(obj.axis_descriptions), 'types.untyped.')
            refs = obj.axis_descriptions.export(writer, [fullpath '/axis_descriptions'], refs);
        elseif ~isempty(obj.axis_descriptions)
            writer.writeValue([fullpath '/axis_descriptions'], obj.axis_descriptions, 'forceArray');
        end
        if ~isempty(obj.focal_depth_image)
            if startsWith(class(obj.focal_depth_image), 'types.untyped.')
                refs = obj.focal_depth_image.export(writer, [fullpath '/focal_depth_image'], refs);
            elseif ~isempty(obj.focal_depth_image)
                writer.writeValue([fullpath '/focal_depth_image'], obj.focal_depth_image, 'forceArray', 'forceMatrix');
            end
        end
        if ~isempty(obj.focal_depth_image) && ~isa(obj.focal_depth_image, 'types.untyped.SoftLink') && ~isa(obj.focal_depth_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/focal_depth_image/bits_per_pixel'], obj.focal_depth_image_bits_per_pixel);
        ...
        if ~isempty(obj.focal_depth_image) && ~isa(obj.focal_depth_image, 'types.untyped.SoftLink') && ~isa(obj.focal_depth_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/focal_depth_image/dimension'], obj.focal_depth_image_dimension, 'forceArray');
        ...
        if ~isempty(obj.focal_depth_image) && ~isa(obj.focal_depth_image, 'types.untyped.SoftLink') && ~isa(obj.focal_depth_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/focal_depth_image/field_of_view'], obj.focal_depth_image_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.focal_depth_image) && ~isa(obj.focal_depth_image, 'types.untyped.SoftLink') && ~isa(obj.focal_depth_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/focal_depth_image/focal_depth'], obj.focal_depth_image_focal_depth);
        ...
        if ~isempty(obj.focal_depth_image) && ~isa(obj.focal_depth_image, 'types.untyped.SoftLink') && ~isa(obj.focal_depth_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/focal_depth_image/format'], obj.focal_depth_image_format);
        ...
        if ~isempty(obj.sign_map)
            if startsWith(class(obj.sign_map), 'types.untyped.')
                refs = obj.sign_map.export(writer, [fullpath '/sign_map'], refs);
            elseif ~isempty(obj.sign_map)
                writer.writeValue([fullpath '/sign_map'], obj.sign_map, 'forceArray', 'forceMatrix');
            end
        end
        if ~isempty(obj.sign_map) && ~isa(obj.sign_map, 'types.untyped.SoftLink') && ~isa(obj.sign_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/sign_map/dimension'], obj.sign_map_dimension, 'forceArray');
        ...
        if ~isempty(obj.sign_map) && ~isa(obj.sign_map, 'types.untyped.SoftLink') && ~isa(obj.sign_map, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/sign_map/field_of_view'], obj.sign_map_field_of_view, 'forceArray');
        ...
        if startsWith(class(obj.vasculature_image), 'types.untyped.')
            refs = obj.vasculature_image.export(writer, [fullpath '/vasculature_image'], refs);
        elseif ~isempty(obj.vasculature_image)
            writer.writeValue([fullpath '/vasculature_image'], obj.vasculature_image, 'forceArray', 'forceMatrix');
        end
        if ~isempty(obj.vasculature_image) && ~isa(obj.vasculature_image, 'types.untyped.SoftLink') && ~isa(obj.vasculature_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/vasculature_image/bits_per_pixel'], obj.vasculature_image_bits_per_pixel);
        ...
        if ~isempty(obj.vasculature_image) && ~isa(obj.vasculature_image, 'types.untyped.SoftLink') && ~isa(obj.vasculature_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/vasculature_image/dimension'], obj.vasculature_image_dimension, 'forceArray');
        ...
        if ~isempty(obj.vasculature_image) && ~isa(obj.vasculature_image, 'types.untyped.SoftLink') && ~isa(obj.vasculature_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/vasculature_image/field_of_view'], obj.vasculature_image_field_of_view, 'forceArray');
        ...
        if ~isempty(obj.vasculature_image) && ~isa(obj.vasculature_image, 'types.untyped.SoftLink') && ~isa(obj.vasculature_image, 'types.untyped.ExternalLink')
            writer.writeAttribute([fullpath '/vasculature_image/format'], obj.vasculature_image_format);
