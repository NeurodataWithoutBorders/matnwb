...
% REQUIRED PROPERTIES
properties
    device; % REQUIRED (Device) Link to the Device object (e.g., microscope) used to acquire images from this imaging plane.
...
methods
    function obj = ImagingPlane(varargin)
        ...
        %  - description (char) - Description of the imaging plane.
        %
        %  - device (Device) - Link to the Device object (e.g., microscope) used to acquire images from this imaging plane.
        %
        ...
        %
        % Output Arguments:
        %  - imagingPlane (types.core.ImagingPlane) - An ImagingPlane object
