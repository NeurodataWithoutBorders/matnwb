...
methods
    function obj = OptogeneticSeries(varargin)
        ...
        %
        %  - data (numeric) - Applied power for optogenetic stimulus, in watts. Shape can be 1-D or 2-D. 2-D data is meant to be used in an extension of OptogeneticSeries that defines what the second dimension represents.
        %
