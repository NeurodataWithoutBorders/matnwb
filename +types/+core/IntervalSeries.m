...
methods
    ...
    function val = validate_data_resolution(obj, val)
        if isequal(val, -1)
            ...
            warning('NWB:Type:ReadOnlyProperty', 'The ''data_resolution'' property of class ''<a href="matlab:doc types.core.IntervalSeries">IntervalSeries</a>'' is invalid according to the NWB schema.')
        end
    end
    function val = validate_data_unit(obj, val)
        if isequal(val, 'n/a')
            ...
            warning('NWB:Type:ReadOnlyProperty', 'The ''data_unit'' property of class ''<a href="matlab:doc types.core.IntervalSeries">IntervalSeries</a>'' is invalid according to the NWB schema.')
        end
    end
    %% EXPORT
