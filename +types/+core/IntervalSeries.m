...
methods
    function obj = IntervalSeries(varargin)
        ...
        if strcmp(class(obj), 'types.core.IntervalSeries') %#ok<STISA>
    ...
    function val = validate_data_resolution(obj, val)
        ...
        val = types.util.checkConstant('data_resolution', constantValue, val, 'types.core.IntervalSeries');
    end
    function val = validate_data_unit(obj, val)
        constantValue = 'n/a';
        val = types.util.checkConstant('data_unit', constantValue, val, 'types.core.IntervalSeries');
    end
    %% EXPORT
