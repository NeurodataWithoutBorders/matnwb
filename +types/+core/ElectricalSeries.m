...
properties (Constant, Access = private)
    SchemaRelativePaths = ["channel_conversion", "channel_conversion/axis", "filtering"];
end
...
methods
    function obj = ElectricalSeries(varargin)
        ...
        %
        % Syntax:
        %  electricalSeries = types.core.ELECTRICALSERIES() creates an ElectricalSeries object with unset property values.
        %
        %  electricalSeries = types.core.ELECTRICALSERIES(Name, Value) creates an ElectricalSeries object where one or more property values are specified using name-value pairs.
        %
