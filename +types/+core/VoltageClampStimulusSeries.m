...
methods
    function obj = VoltageClampStimulusSeries(varargin)
        ...
        if strcmp(class(obj), 'types.core.VoltageClampStimulusSeries') %#ok<STISA>
    ...
    function val = validate_data_unit(obj, val)
        constantValue = 'volts';
        val = types.util.checkConstant('data_unit', constantValue, val, 'types.core.VoltageClampStimulusSeries');
    end
    %% EXPORT
