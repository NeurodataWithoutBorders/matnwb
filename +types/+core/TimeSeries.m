...
properties
    ...
    data_resolution = -1; %  (single) Smallest meaningful difference between values in data, stored in the specified unit, e.g., the change in value of the least significant bit, or a larger number if signal noise is known to be present. If unknown, use -1.0.
