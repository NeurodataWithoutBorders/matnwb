...
if strcmp(dataType, 'logical')
    % for some reason, MATLAB prefers doubles when concatenating logicals
    % to an empty double array. This is in contrast to every other type (cells,
    % structs, integer types, singles, etc.) which returns the appending
    % type instead of the empty double array.
