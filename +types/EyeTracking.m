classdef EyeTracking < types.NWBContainer
  ...
  methods %constructor
    function obj = EyeTracking(varargin)
      ...
      obj.help = {'Eye-tracking data, representing direction of gaze'};
      ...
      if ~isempty(gn)
        for i=1:length(gn)
          gnm = gn{i};
          if isfield(obj, gnm)
            error('Naming conflict found in EyeTracking object property name: ''%s''', gnm);
          else
            addprop(obj, gnm);
