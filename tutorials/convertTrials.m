...
dynTable = util.createElectrodeTable();
dynTable.id.data = int64(1:etrodeNum);
dynTable.vectordata.get('x').data = etrodeMat(:,1);
dynTable.vectordata.get('y').data = etrodeMat(:,2);
dynTable.vectordata.get('z').data = etrodeMat(:,3);
dynTable.vectordata.get('imp').data = zeros(etrodeNum,1);
dynTable.vectordata.get('location').data = repmat({recordingLocation}, etrodeNum, 1);
dynTable.vectordata.get('filtering').data = emptyStr;
dynTable.vectordata.get('group').data = repmat(types.untyped.ObjectView(egroupPath), etrodeNum, 1);
dynTable.vectordata.get('group_name').data = repmat({probetype}, etrodeNum, 1);
