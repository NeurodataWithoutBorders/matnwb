...
% more detail here: <./dimensionMapNoDataPipes.mlx MatNWB <-> HDF5 Dimension Mapping>.
%% Set up the NWB file
...
nwb
% Subject Information
% It is recommended to store information about the experimental subject in the 
% file. Create a <https://matnwb.readthedocs.io/en/latest/pages/neurodata_types/core/Subject.html 
...
% <https://matnwb.readthedocs.io/en/latest/pages/neurodata_types/core/PlaneSegmentation.html 
