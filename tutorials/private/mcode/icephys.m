...
% |*DynamicTables*|> enabling users to add columns for custom metadata. Storing 
% data in hierarchical tables has the advantage that it allows us to avoid duplication 
