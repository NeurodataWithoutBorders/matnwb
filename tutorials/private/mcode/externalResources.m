...
% holds the values, rather than to the table, and its |relative_path| is empty. A ragged column works the same way: |Attribute| names 
...
readFile.general_external_resources.getObjectEntities( ...
    readFile, readFile.general_subject, Attribute = "species")
%% Notes
