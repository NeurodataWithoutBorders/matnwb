classdef NwbFile < types.core.NWBFile
    ...
    methods
        ...
        function tbl = create_electrode_table(obj)
            ...
            if ~isempty(obj.general_extracellular_ephys_electrodes)
                warning(['The Electrodes Table property '...
                    '`general_extracellular_ephys_electrodes` is not empty.  '...
                    'Skipping overwrite.']);
                return;
            end
            obj.general_extracellular_ephys_electrodes = tbl;
        end
    end
